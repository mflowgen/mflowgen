...
# Fix for operators
#
# 28nm tiny designs have no room to place due to extra area from
# welltaps and endcaps! So if the design is 28nm and super tiny, then we
# just make the density target smaller to get some more space.

if { $ADK_PROCESS == 28 } {
  if { [ dbGet top.fPlan.coreBox_area ] < 50 } {
    set core_density_target 0.50;
  }
}

...
(iopad
	...
	(inst  name="vss_io_0_bond"     space=-80.0)
	(inst  name="vss_core_dummy_0_pad"  offset=220.0000) # placeholder
	(inst  name="vss_core_dummy_0_bond"  space=-80.0) # placeholder
	(inst  name="vss_core_dummy_1_pad"  offset=320.0000) # placeholder
	(inst  name="vss_core_dummy_1_bond"  space=-80.0) # placeholder
	(inst  name="ADC_I_9_pad"      offset=420.0000)
	(inst  name="ADC_I_9_bond"      space=-80.0)
	...
	(inst  name="vss_core_0_bond"   space=-80.0)
    )
    (row
	(locals row_name="iorow_E")
	(inst  name="vdd_core_2_pad"	 offset= 20.0000)
	(inst  name="vdd_core_2_bond"	 offset= 20.0000)
	(inst  name="ADC_Q_5_pad"	  offset= 120.0000)
	(inst  name="ADC_Q_5_bond"	  offset= 120.0000)
	(inst  name="ADC_Q_4_pad"	  offset= 220.0000)
	(inst  name="ADC_Q_4_bond"	  offset= 220.0000)
	(inst  name="ADC_Q_3_pad"	  offset= 320.0000)
	(inst  name="ADC_Q_3_bond"	  offset= 320.0000)
	(inst  name="ADC_Q_2_pad"	  offset= 420.0000)
	(inst  name="ADC_Q_2_bond"	  offset= 420.0000)
	(inst  name="ADC_Q_1_pad"	  offset= 520.0000)
	(inst  name="ADC_Q_1_bond"	  offset= 520.0000)
	(inst  name="ADC_Q_0_pad"	  offset= 620.0000)
	(inst  name="ADC_Q_0_bond"	  offset= 620.0000)
	(inst  name="vdd_poc_0_pad"	  offset= 720.0000)
	(inst  name="vdd_poc_0_bond"	  offset= 720.0000)
	(inst  name="vss_io_1_pad"  offset= 820.0000)
	(inst  name="vss_io_1_bond"  offset= 820.0000)
	(inst  name="vss_core_1_pad"  offset= 920.0000) # middle right
	(inst  name="vss_core_1_bond"  offset= 920.0000) # middle right
	(inst  name="vdd_core_1_pad"	  offset=1020.0000)
	(inst  name="vdd_core_1_bond"	  offset=1020.0000)
	(inst  name="greset_n_pad"	  offset=1120.0000)
	(inst  name="greset_n_bond"	  offset=1120.0000)
	(inst  name="ADC_I_0_pad"	  offset=1220.0000)
	(inst  name="ADC_I_0_bond"	  offset=1220.0000)
	(inst  name="ADC_I_1_pad"	  offset=1320.0000)
	(inst  name="ADC_I_1_bond"	  offset=1320.0000)
	(inst  name="ADC_I_2_pad"	  offset=1420.0000)
	(inst  name="ADC_I_2_bond"	  offset=1420.0000)
	(inst  name="ADC_I_3_pad"	  offset=1520.0000)
	(inst  name="ADC_I_3_bond"	  offset=1520.0000)
	(inst  name="ADC_I_4_pad"	  offset=1620.0000)
	(inst  name="ADC_I_4_bond"	  offset=1620.0000)
	(inst  name="ADC_I_5_pad"	  offset=1720.0000)
	(inst  name="ADC_I_5_bond"	  offset=1720.0000)
	(inst  name="vdd_core_0_pad"  offset=1820.0000)
	(inst  name="vdd_core_0_bond"  offset=1820.0000)
    )
    (row
	(locals row_name="iorow_S")
	(inst  name="vdd_io_1_pad"   offset=20.0000)
	(inst  name="vdd_io_1_bond"   offset=20.0000)
	(inst  name="vss_io_2_pad"      offset=120.0000)
	(inst  name="vss_io_2_bond"      offset=120.0000)
	(inst  name="vss_core_dummy_3_pad"      offset=220.0000)
	(inst  name="vss_core_dummy_3_bond"      offset=220.0000)
	(inst  name="vss_core_dummy_2_pad"      offset=320.0000)
	(inst  name="vss_core_dummy_2_bond"      offset=320.0000)
	(inst  name="ADC_Q_9_pad"      offset=420.0000)
	(inst  name="ADC_Q_9_bond"      offset=420.0000)
	(inst  name="ADC_Q_8_pad"  offset=520.0000) # placeholder
	(inst  name="ADC_Q_8_bond"  offset=520.0000) # placeholder
	(inst  name="ADC_Q_7_pad"  offset=620.0000) # placeholder
	(inst  name="ADC_Q_7_bond"  offset=620.0000) # placeholder
	(inst  name="ADC_Q_6_pad"     offset=720.0000)
	(inst  name="ADC_Q_6_bond"     offset=720.0000)
	(inst  name="vss_core_2_pad"     offset=820.0000)
	(inst  name="vss_core_2_bond"     offset=820.0000)
    )
)

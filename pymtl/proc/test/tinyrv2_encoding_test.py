...
def test_tinyrv2_inst_rv32f():
  ...
  check( "feq.s  f1,  f2,  f3",     0b10100000001100010010000011010011, "feq.s  f01, f02, f03" )
  check( "flt.s  f1,  f2,  f3",     0b10100000001100010001000011010011, "flt.s  f01, f02, f03" )
  check( "fle.s  f1,  f2,  f3",     0b10100000001100010000000011010011, "fle.s  f01, f02, f03" )

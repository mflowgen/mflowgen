...
class ProcCtrlPRTL( Model ):
  ...
  def __init__( s, reset_freeze = False ):
    ...
    def comb_control_table_D():
      ...
      elif inst == FEQS   : s.cs.value = concat( y, y, y, fp_ceq, y, br_na, n, am_rf, y, imm_x, bm_rf,  y, alu_x,   mem_nr,  mlen_x, xm_f, dm_x,  wm_a, y,  md_x,    n, n )
      elif inst == FLTS   : s.cs.value = concat( y, y, y, fp_clt, y, br_na, n, am_rf, y, imm_x, bm_rf,  y, alu_x,   mem_nr,  mlen_x, xm_f, dm_x,  wm_a, y,  md_x,    n, n )
      elif inst == FLES   : s.cs.value = concat( y, y, y, fp_cle, y, br_na, n, am_rf, y, imm_x, bm_rf,  y, alu_x,   mem_nr,  mlen_x, xm_f, dm_x,  wm_a, y,  md_x,    n, n )

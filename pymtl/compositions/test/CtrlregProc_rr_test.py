...
def test_add_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_add.gen_random_test, dump_vcd, test_verilog,
...
def test_sub_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_sub.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_mul_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_mul.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_mulh_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_mulh.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_mulhsu_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_mulhsu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_mulhu_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_mulhu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_div_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_div.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_divu_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_divu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_rem_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_rem.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_remu_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_remu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_and_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_and.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_or_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_or.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_xor_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_xor.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slt_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_slt.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sltu_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_sltu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sra_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_sra.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srl_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_srl.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sll_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_sll.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

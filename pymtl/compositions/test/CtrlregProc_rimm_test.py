...
def test_addi_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_addi.gen_random_test, dump_vcd, test_verilog,
...
def test_andi_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_andi.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_ori_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_ori.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_xori_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_xori.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slti_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_slti.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sltiu_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_sltiu.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srai_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_srai.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srli_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_srli.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slli_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_slli.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_lui_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_lui.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_auipc_rand_delays( dump_vcd, test_verilog ):
  run_test( CtrlregProc, inst_auipc.gen_random_test, dump_vcd, test_verilog,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )

#=========================================================================
# CompCtrlregMcoreL0ArbiterMduCache_test.py
#=========================================================================
...
def run_test( test, dump_vcd, test_verilog,
  ...
  from CompCtrlregMcoreL0ArbiterMduCache_harness import run_test as run

  run( CompCtrlregMcoreL0ArbiterMduCache( num_cores ), test, num_cores, cacheline_nbits,

#===============================================================================
# HostCompCtrlregMcoreL0ArbiterMduCache.py
#===============================================================================
...
from CompCtrlregMcoreL0ArbiterMduCache import CompCtrlregMcoreL0ArbiterMduCache

class HostCompCtrlregMcoreL0ArbiterMduCache( Model ):

  def __init__( s, asynch_bitwidth = 8 ):

    s.explicit_modulename = 'HostCompCtrlregMcoreL0ArbiterMduCache'
...
#    s.debug = OutPort( 1 )
    ...
    s.dut = CompCtrlregMcoreL0ArbiterMduCache()

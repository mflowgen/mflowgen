...
from sram.SramWrapper28nmPRTL import SramWrapper28nmPRTL
...
def test_direct_16x32( dump_vcd, test_verilog ):
  ...
  run_test_vector_sim( SramWrapper28nmPRTL(16, 32), test_vectors, dump_vcd, test_verilog )
...
def test_direct_32x256( dump_vcd, test_verilog ):
  ...
  run_test_vector_sim( SramWrapper28nmPRTL(32, 256), test_vectors, dump_vcd, test_verilog )
...
def test_direct_128x256( dump_vcd, test_verilog ):
  ...
  run_test_vector_sim( SramWrapper28nmPRTL(128, 256), test_vectors, dump_vcd, test_verilog )
...
def test_direct_64x64( dump_vcd, test_verilog ):
  ...
  run_test_vector_sim( SramWrapper28nmPRTL(64, 64), test_vectors, dump_vcd, test_verilog )
...
def test_random( num_bits, num_words, dump_vcd, test_verilog ):
  run_test_vector_sim( SramWrapper28nmPRTL(num_bits, num_words),

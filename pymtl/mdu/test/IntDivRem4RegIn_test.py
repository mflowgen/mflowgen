...
from mdu.IntDivRem4RegIn import IntDivRem4RegIn
...
class TestHarness (Model):
  ...
  def __init__( s, nbits, src_msgs, sink_msgs,
    ...
    s.idiv = IntDivRem4RegIn ( nbits, 8 )
    ...
    if test_verilog:
      s.idiv = TranslationTool( s.idiv, verilator_xinit=test_verilog )
...
def test( test_params, dump_vcd, test_verilog ):
  run_sim( TestHarness( 32,
                        ...
                        dump_vcd, test_verilog ), max_cycles=2000
            )

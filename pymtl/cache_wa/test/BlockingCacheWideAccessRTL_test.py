#=========================================================================
# BlockingCacheWideAccessRTL_test.py
#=========================================================================
...
from BlockingCacheWideAccessFL_test import *

from cache_wa.BlockingCacheWideAccessRTL import BlockingCacheWideAccessRTL
...
#                 src_delay, sink_delay, CacheModel, check_test, 
#                 test_node, dump_vcd )
#
...
def test_generic( test_params, dump_vcd, test_verilog ):
  ...
  harness = TestHarness( msgs[::2], msgs[1::2],
                         ...
                         BlockingCacheWideAccessRTL, True, dump_vcd,
                         test_verilog )

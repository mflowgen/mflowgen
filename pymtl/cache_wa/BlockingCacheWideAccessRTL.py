...
from BlockingCacheWideAccessPRTL import BlockingCacheWideAccessPRTL as BlockingCacheWideAccessRTL
#elif rtl_language == 'verilog':
#  from BlockingCacheVRTL import BlockingCacheVRTL as BlockingCacheWideAccessRTL
#else:
